...
consumer_key_env = os.environ['CONSUMERKEY']
consumer_key=base64.b64decode(consumer_key_env)
print('consumer_key_env is : {} and type is {}'.format(consumer_key_env, type(consumer_key_env)))
print('consumer_key is : {} and type is {}'.format(consumer_key, type(consumer_key)))

consumer_secret_env = os.environ['CONSUMERSECRET']
consumer_secret = base64.b64decode(consumer_secret_env)

print('consumer_secret_env is : {}'.format(consumer_secret_env))
print('consumer_secret is : {}'.format(consumer_secret))

access_token_env = os.environ['ACCESSTOKEN']
access_token = base64.b64decode(access_token_env)

print('access_token_env is : {}'.format(access_token_env))
print('access_token is : {}'.format(access_token))

access_token_secret_env = os.environ['ACCESSTOKENSEC']
access_token_secret = base64.b64decode(access_token_secret_env)

print('access_token_secret_env is : {}'.format(access_token_secret_env))
print('access_token_secret is : {}'.format(access_token_secret))
